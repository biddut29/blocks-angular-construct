    ...
    <div class="bg-card rounded-xl border border-border p-8 shadow-sm">
      ...
      <form *ngIf="!success()" [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4">
        <div class="space-y-1.5">
          ...
          <div class="relative">
            <input [type]="showPwd() ? 'text' : 'password'" formControlName="password" placeholder="Minimum 8 characters"
            ...
            <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground" (click)="showPwd.set(!showPwd())">
        ...
        <div class="space-y-1.5">
          ...
          <input type="password" formControlName="confirmPassword" placeholder="Repeat your password"
            ...
            [class.border-destructive]="form.hasError('passwordMismatch') && form.get('confirmPassword')?.touched" />
          <p *ngIf="form.hasError('passwordMismatch') && form.get('confirmPassword')?.touched" class="text-destructive text-xs">
