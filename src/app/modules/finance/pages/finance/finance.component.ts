  ...
  template: `
    <div class="p-6 space-y-6">
      ...
      <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Track your revenue, expenses and transactions.</p>
      </div>
      ...
      @if (summary()) {
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <!-- Total Revenue -->
          <div hlmCard class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
            <div hlmCardHeader class="flex items-center justify-between px-6 pt-6 pb-2">
              <p hlmCardTitle class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Revenue</p>
              <div class="p-2 rounded-lg bg-green-50 dark:bg-green-900/30">
                <ng-icon name="lucideDollarSign" class="text-green-600 dark:text-green-400" size="18"></ng-icon>
              </div>
            </div>
            <div hlmCardContent class="px-6 pb-6">
              <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ summary()!.totalRevenue | currency }}</div>
              <div class="flex items-center gap-1 mt-1">
                <ng-icon name="lucideArrowUpRight" class="text-green-500" size="14"></ng-icon>
                <span class="text-green-600 text-xs font-medium">+{{ summary()!.revenueChange }}%</span>
              </div>
            </div>
          </div>
          ...
          <div hlmCard class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
            <div hlmCardHeader class="flex items-center justify-between px-6 pt-6 pb-2">
              <p hlmCardTitle class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Expense</p>
              <div class="p-2 rounded-lg bg-red-50 dark:bg-red-900/30">
                <ng-icon name="lucideTrendingDown" class="text-red-600 dark:text-red-400" size="18"></ng-icon>
              </div>
            </div>
            <div hlmCardContent class="px-6 pb-6">
              <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ summary()!.totalExpense | currency }}</div>
              <div class="flex items-center gap-1 mt-1">
                <ng-icon name="lucideArrowUpRight" class="text-red-500" size="14"></ng-icon>
                <span class="text-red-600 text-xs font-medium">+{{ summary()!.expenseChange }}%</span>
              </div>
            </div>
          </div>
          ...
          <div hlmCard class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
            <div hlmCardHeader class="flex items-center justify-between px-6 pt-6 pb-2">
              <p hlmCardTitle class="text-sm font-medium text-gray-500 dark:text-gray-400">Net Profit</p>
              <div class="p-2 rounded-lg bg-indigo-50 dark:bg-indigo-900/30">
                <ng-icon name="lucideTrendingUp" class="text-indigo-600 dark:text-indigo-400" size="18"></ng-icon>
              </div>
            </div>
            <div hlmCardContent class="px-6 pb-6">
              <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ summary()!.netProfit | currency }}</div>
              <div class="flex items-center gap-1 mt-1">
                <ng-icon name="lucideArrowUpRight" class="text-green-500" size="14"></ng-icon>
                <span class="text-green-600 text-xs font-medium">+{{ summary()!.profitChange }}%</span>
              </div>
            </div>
          </div>
      ...
      <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm p-6">
        <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Revenue vs Expense</h2>
            ...
            <tbody>
              @for (txn of transactions(); track txn.transactionId) {
                <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                  <td class="px-6 py-4 text-gray-600 dark:text-gray-400 font-mono text-xs">{{ txn.transactionId }}</td>
                  <td class="px-6 py-4">
                    <span [class]="txn.type === 'INCOME'
                  ...
                  <td class="px-6 py-4 text-right font-semibold"
                      [class]="txn.type === 'INCOME' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
